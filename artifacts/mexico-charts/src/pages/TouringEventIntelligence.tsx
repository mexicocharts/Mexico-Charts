  ...
  return <div className="min-h-screen bg-[#070707] text-white"><PageSEO title="Inteligencia de evento | Mexico Charts" description="Historial público, precios primary y estimaciones transparentes." path={`/touring/event/${eventId}`} noindex/><SiteNav/>
    <main className="mx-auto max-w-5xl px-6 py-16"><Link href="/touring" className="text-xs font-black uppercase tracking-[.18em] text-[#39FF14]">← Touring</Link>
      ...
      <section className="mt-10 grid gap-4 md:grid-cols-3">
        ...
        <article className="border border-white/10 bg-white/[.02] p-5"><span className="text-[9px] font-black uppercase tracking-[.18em] text-zinc-500">Gross estimado USD</span><strong className="mt-3 block text-2xl">{economics?.estimatedGrossUsd?`${money(economics.estimatedGrossUsd.low)}–${money(economics.estimatedGrossUsd.high)}`:"No disponible"}</strong><p className="mt-2 text-xs text-zinc-500">Estimación, no box office reportado. Confianza: {economics?.estimatedGrossUsd?.confidence??"insuficiente"}.</p></article>
      </section>

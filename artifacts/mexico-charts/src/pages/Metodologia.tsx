          ...
          <section>
            ...
            <div className="overflow-hidden rounded-xl" style={cardStyle}>
              {[
                ...
                ["MX100", pick("Se recalcula cuando cambian sus entradas de Spotify semanal, YouTube semanal o Apple Music. Las fechas de corte pueden diferir porque Apple Music publica con mayor frecuencia.", "Recalculated when its weekly Spotify, weekly YouTube or Apple Music inputs change. Cutoff dates may differ because Apple Music publishes more frequently.")],
          ...
          <section>
            ...
            <div className="rounded-xl p-6 mb-4" style={{ background: "rgba(57,255,20,0.04)", border: "1px solid rgba(57,255,20,0.14)" }}>
              ...
              <p className="text-sm leading-relaxed" style={{ color: "rgba(255,255,255,0.52)" }}>
                {pick("MX100 es un ranking editorial calculado por Mexico Charts que ordena hasta 100 artistas de música mexicana actualmente monitoreados a partir de su presencia en listas oficiales de consumo en México. Combina señales de Spotify, YouTube y Apple Music para ofrecer una lectura multiplataforma; no reproduce ninguna de esas listas por separado ni representa necesariamente a la totalidad de artistas mexicanos.", "MX100 is an editorial ranking calculated by Mexico Charts that orders up to 100 currently monitored Mexican-music artists based on their presence in official Mexico consumption charts. It combines Spotify, YouTube and Apple Music signals to provide a cross-platform view; it does not reproduce any one of those charts and does not necessarily represent every Mexican artist.")}
              </p>
            </div>
            ...
            <div className="grid gap-3 md:grid-cols-3 mb-4">
              {[
                ...
                ["YouTube", pick("Utiliza la lista semanal oficial de artistas y las vistas registradas en México durante el periodo disponible.", "Uses the official weekly artist chart and views recorded in Mexico during the available period.")],
                ["Apple Music", pick("Construye una señal a nivel artista a partir de apariciones verificadas en las listas oficiales de canciones y álbumes de Apple Music México. La posición más fuerte tiene mayor importancia y la amplitud de catálogo aporta de forma limitada.", "Builds an artist-level signal from verified appearances on Apple Music Mexico's official song and album charts. The strongest position carries the most importance and catalog breadth contributes on a limited basis.")],
              ].map(([title, body]) => (
                <div key={title} className="rounded-xl p-5" style={cardStyle}>
            ...
            <div className="grid gap-3 md:grid-cols-2">
              {[
                [pick("Elegibilidad por consumo", "Consumption eligibility"), pick("Para entrar a MX100, un artista debe tener al menos una señal verificable dentro de las listas utilizadas de Spotify México, YouTube México o Apple Music México. Fanbase, seguidores y giras no forman parte del cálculo ni pueden generar elegibilidad por sí solos.", "To enter MX100, an artist must have at least one verifiable signal within the Spotify Mexico, YouTube Mexico or Apple Music Mexico charts used. Fanbase, followers and touring are not part of the calculation and cannot create eligibility on their own.")],

        ...
        <div style={{ borderTop: `1px solid rgba(57,255,20,0.12)` }} className="mt-14 pt-12 space-y-10">
          ...
          <section>
            ...
            <div className="grid gap-3 md:grid-cols-2">
              {[
                [pick("Elegibilidad por consumo", "Consumption eligibility"), pick("Para entrar a MX100, un artista debe tener al menos una señal verificable dentro de las listas utilizadas de Spotify México, YouTube México o Apple Music México.", "To enter MX100, an artist must have at least one verifiable signal within the Spotify Mexico, YouTube Mexico or Apple Music Mexico charts used.")],

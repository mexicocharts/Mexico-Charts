          ...
          <FadeUp>
            <div>
              ...
              <div className="flex flex-col gap-5">
                ...
                <p style={bodyStyle}>
                  Desde el lado del contenido, el <Link href="/generos" style={strongStyle}>corrido tumbado</Link> y el <Link href="/generos" style={strongStyle}>regional mexicano</Link> son los géneros que más han empujado el consumo tanto dentro como fuera del país. Artistas como <Link href="/artist/peso-pluma" style={strongStyle}>Peso Pluma</Link>, <Link href="/artist/fuerza-regida" style={strongStyle}>Fuerza Regida</Link>, <Link href="/artist/natanael-cano" style={strongStyle}>Natanael Cano</Link> y <Link href="/artist/carin-leon" style={strongStyle}>Carin León</Link> no solo dominan las charts mexicanas — han logrado colocar a México en el mapa global del streaming, generando revenue en mercados que históricamente no consumían música en español.
                </p>
                <p style={bodyStyle}>

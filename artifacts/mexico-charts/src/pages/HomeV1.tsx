  ...
  return (
    <div className="min-h-[100dvh] bg-background text-foreground overflow-x-hidden selection:bg-primary selection:text-black">
      ...
      <div className="bg-primary/10 border-b border-primary/20 text-center py-2 text-xs font-bold text-primary uppercase tracking-widest flex items-center justify-center gap-4">
        ...
        <span className="text-primary/30">|</span>
        <Link href="/v5" className="underline hover:text-white transition-colors">Ver V5 →</Link>
      </div>
      ...
      <nav className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/80 backdrop-blur-xl" data-testid="navigation">
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 font-display font-semibold tracking-wide uppercase text-sm">
            <Link href="/v1" className="text-primary hover:text-primary/80 transition-colors" data-testid="link-nav-inicio">Inicio</Link>
      ...
      <section className="border-b border-border bg-[#050505]" data-testid="section-stats">
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-border/50 text-center">
            <div className="px-4">
              <div className="text-3xl md:text-4xl font-display font-bold text-white mb-1">1,240</div>
              <div className="text-xs text-zinc-500 uppercase tracking-wider font-semibold">Canciones Monitoreadas</div>
            </div>
            <div className="px-4">
              <div className="text-3xl md:text-4xl font-display font-bold text-primary mb-1 drop-shadow-[0_0_10px_rgba(57,255,20,0.5)]">89</div>
              <div className="text-xs text-zinc-500 uppercase tracking-wider font-semibold">Artistas en el Chart</div>
            </div>
            <div className="px-4">
              <div className="text-3xl md:text-4xl font-display font-bold text-white mb-1">2.4B</div>
              <div className="text-xs text-zinc-500 uppercase tracking-wider font-semibold">Reproducciones Totales</div>
            </div>
            <div className="px-4">
              <div className="text-3xl md:text-4xl font-display font-bold text-zinc-400 mb-1">19</div>
        ...
        <div className="container mx-auto px-4 flex flex-col lg:flex-row gap-16">
          ...
          <div className="flex-1">
            <div className="flex items-end justify-between mb-10 pb-4 border-b border-border">
              ...
              <button className="hidden sm:flex items-center gap-2 text-sm text-white hover:text-primary transition-colors uppercase font-bold tracking-wider">
            ...
            <button className="w-full mt-6 py-4 border border-border text-white font-bold uppercase tracking-widest hover:bg-primary hover:text-black hover:border-primary transition-colors sm:hidden">
              Ver Top Completo
            </button>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8 mb-12">
            ...
            <div className="flex flex-wrap justify-center gap-6 font-mono text-sm text-zinc-500 uppercase tracking-wider">
              <Link href="#charts" className="hover:text-primary transition-colors">Charts</Link>
              <Link href="#artistas" className="hover:text-primary transition-colors">Artistas</Link>
              <Link href="#generos" className="hover:text-primary transition-colors">Géneros</Link>
              <Link href="#historial" className="hover:text-primary transition-colors">Historial</Link>
            </div>
          </div>

...
export default function Privacidad() {
  ...
  const privacyItems = [
    ...
    { title: pick("Cuentas y preferencias", "Accounts and preferences"), body: pick("Si creas una cuenta, el proveedor de autenticación gestiona el acceso seguro y Mexico Charts conserva los datos necesarios para tu perfil, plan, artistas guardados y preferencias de alertas. No exigimos una cuenta para consultar las páginas públicas.", "If you create an account, the authentication provider manages secure access and Mexico Charts stores the information needed for your profile, plan, saved artists and alert preferences. An account is not required to view public pages."), icon: ShieldCheck },

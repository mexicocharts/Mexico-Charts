...
const ARTISTS = [
  ...
  // — added from full-DB scan —
  { id: "olivia-rodrigo",             name: "Olivia Rodrigo",               attractionId: "K8vZ917_Su0" },
  { id: "bruno-mars",                 name: "Bruno Mars",                   attractionId: "K8vZ917GJc7" },
  { id: "bad-bunny",                  name: "Bad Bunny",                    attractionId: "K8vZ9174l1f" },
  { id: "pitbull",                    name: "Pitbull",                      attractionId: "K8vZ917Gp10" },
  { id: "harry-styles",               name: "Harry Styles",                 attractionId: "K8vZ9174XZ0" },
  { id: "the-weeknd",                 name: "The Weeknd",                   attractionId: "K8vZ9172Ln7" },
  { id: "karol-g",                    name: "Karol G",                      attractionId: "K8vZ917p3-V" },
  { id: "ariana-grande",              name: "Ariana Grande",                attractionId: "K8vZ9172Qo7" },
  { id: "gorillaz",                   name: "Gorillaz",                     attractionId: "K8vZ9171zxV" },
  { id: "mon-laferte",                name: "Mon Laferte",                  attractionId: "K8vZ917Kit0" },
  { id: "shakira",                    name: "Shakira",                      attractionId: "K8vZ9171xeV" },
  { id: "dominic-fike",               name: "Dominic Fike",                 attractionId: "K8vZ917bFKV" },
  { id: "oliver-tree",                name: "Oliver Tree",                  attractionId: "K8vZ9174ysV" },
  { id: "duelo",                      name: "Grupo Duelo",                  attractionId: "K8vZ917uYv7" },
  { id: "hombres-g",                  name: "Hombres G",                    attractionId: "K8vZ9171sp7" },
  ...
  { id: "calvin-harris",              name: "Calvin Harris",                attractionId: "K8vZ9175TJ0" },
  { id: "young-miko",                 name: "Young Miko",                   attractionId: "K8vZ917hET7" },
  { id: "cristian-castro",            name: "Cristian Castro",              attractionId: "K8vZ9175rm0" },
  { id: "kany-garcia",                name: "Kany García",                  attractionId: "K8vZ917KB97" },
  ...
  { id: "kali-uchis",                 name: "Kali Uchis",                   attractionId: "K8vZ917K490" },
  { id: "hermanos-espinoza",          name: "Hermanos Espinoza",            attractionId: "K8vZ917rqOV" },
  { id: "linkin-park",                name: "Linkin Park",                  attractionId: "K8vZ9171if7" },
  { id: "yandel",                     name: "Yandel",                       attractionId: "K8vZ917oID0" },
  { id: "los-lobos",                  name: "Los Lobos",                    attractionId: "K8vZ9171CI0" },
  { id: "romeo-santos",               name: "Romeo Santos",                 attractionId: "K8vZ9172820" },
  ...
  { id: "aitana",                     name: "Aitana",                       attractionId: "K8vZ917bZ-V" },
  { id: "camilo",                     name: "Camilo",                       attractionId: "K8vZ917_FzV" },
  ...
  { id: "soda-stereo",                name: "Soda Stereo",                  attractionId: "K8vZ917G7y7" },
  { id: "temper-city",                name: "Temper City",                  attractionId: "K8vZ917O7xf" },
  { id: "enjambre",                   name: "Enjambre",                     attractionId: "K8vZ9175RK7" },
  { id: "farruko",                    name: "Farruko",                      attractionId: "K8vZ917oBR7" },
  { id: "hugel",                      name: "Hugel",                        attractionId: "K8vZ917bZg0" },
  ...
  { id: "paulo-londra",               name: "Paulo Londra",                 attractionId: "K8vZ917bAfV" },
  { id: "ryan-castro",                name: "Ryan Castro",                  attractionId: "K8vZ917Q4fV" },
  { id: "alicia-villarreal",          name: "Alicia Villarreal",            attractionId: "K8vZ9175znf" },
  { id: "anuel-aa",                   name: "Anuel AA",                     attractionId: "K8vZ9179r_f" },
  ...
  { id: "manuel-turizo",              name: "Manuel Turizo",                attractionId: "K8vZ9179kF0" },
  { id: "milo-j",                     name: "Milo J",                       attractionId: "K8vZ917hrZ0" },
  { id: "rogelio-martinez",           name: "Rogelio Martinez",             attractionId: "K8vZ917uwv7" },
  { id: "sebastian-yatra",            name: "Sebastián Yatra",              attractionId: "K8vZ9174WNf" },
  ...
  { id: "de-la-rose",                 name: "De La Rose",                   attractionId: "K8vZ917rajV" },
  { id: "el-as-de-la-sierra",         name: "El As de la Sierra",           attractionId: "K8vZ917hlm7" },
  { id: "feid",                       name: "Feid",                         attractionId: "K8vZ917_cQ7" },
  { id: "imagine-dragons",            name: "Imagine Dragons",              attractionId: "K8vZ917GSz7" },
  ...
  { id: "myke-towers",                name: "Myke Towers",                  attractionId: "K8vZ917bvff" },
  { id: "ozuna",                      name: "Ozuna",                        attractionId: "K8vZ9174-y0" },
  ...
  { id: "the-jacksons",               name: "The Jacksons",                 attractionId: "K8vZ9172PFf" },
  ...
  { id: "david-guetta",               name: "David Guetta",                 attractionId: "K8vZ917G-90" },
  ...
  { id: "hadrian",                    name: "Hadrian",                      attractionId: "K8vZ917LbXf" },
  ...
  { id: "wisin",                      name: "Wisin",                        attractionId: "K8vZ917KNb7" },
  { id: "yan-block",                  name: "Yan Block",                    attractionId: "K8vZ917rls0" },
  { id: "yung-beef",                  name: "Yung Beef",                    attractionId: "K8vZ91745i0" },
